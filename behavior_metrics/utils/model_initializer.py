...
"""This module contains the model initializer.

This module is used to initialize the model of the robot in a desired configuration.
Like, setting the noise and position of the sensors on the robot.
...
# Ways
# 1. Similar way, take the old file, change it, save as temp and relaunch
# 2. 
